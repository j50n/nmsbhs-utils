...
import { GalacticCenter } from "./coordinates";
...
class DijkstraShortestPathSolver {
    ...
    calculateFor(startNode) {
        ...
        weights[startNode] = 0;
        const pq = new TinyQueue([{ node: startNode, weight: 0 }], (a, b) => a.weight - b.weight);
...
export { DijkstraCalculator, dijkstraCalculator, DijkstraShortestPathSolver, isSameRegion, isSameStar, isAdjacentRegion, calcExpectedJumps, Route, };
